...
var tree = {
	 ...
	 * 加载子节点或者根节点
	 */
	loadSubNode:function(treeJson){
		$.post("menuitemAction_showMeuitemsByPid.action", treeJson.parameter, function(data){
			//这里采用了回调函数的形式，因为在写该方法的时候，回调函数中的内容应该由调用者完成
            treeJson.callback(data);
        });
	}
};
$().ready(function(){
