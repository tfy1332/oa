...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">HbSy  OA</font> 
        ...
        <div id="Head1Right_SystemButton">
            <a target="_parent" href="System_User/logout.html">
				<img width="78" height="20" alt="退出系统" src="${pageContext.request.contextPath}/css/blue/images/top/logout.gif" onclick="logout();"/>
			</a>
        </div>
    ...
    <div id="Head2">
		...
		<div id="Head2_FunctionList">
			<marquee ${pageContext.request.contextPath}/css="WIDTH: 100%;" onMouseOver="this.stop()" onMouseOut="this.start()" 
