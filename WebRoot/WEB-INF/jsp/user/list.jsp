...
<script language="javascript" src="${pageContext.request.contextPath}/js/jquery-oa-utils.js"></script>
...
<div id="MainArea">
    ...
    <div class="ItemBlock_Title1" id="privilegeTitle" style="display: none;"><div class="ItemBlock_Title1">
        ...
        <div id="InputDetailBar">
            <img src="${pageContext.request.contextPath}/css/images/save.png"/>
        </div>
</div>
