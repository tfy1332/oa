        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <!-- 
                    	list：
                    	   list下拉列表框中的数据  值能直接跟ognl表达式
                     -->
                    
                        <td>
                        	<s:select list="#dList" listKey="did" listValue="dname" headerKey="" headerValue="请选择部门" cssClass="SelectStyle" name="did"></s:select>
                        </td>
                    </tr>
                    <tr><td>用户名</td>
					...
					<tr><td>性别</td>
                        <td>
                        	<s:radio name="sex" list="{'男','女'}" value="'男'"/>
						</td>
                    </tr>
					<tr><td>联系电话</td>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td>
                        	<s:select list="#pList" listKey="pid" listValue="pname" multiple="true" size="10" cssClass="SelectStyle" name="pids"></s:select>
                        </td>
                    </tr>
                </table>
            </div>
